...
function renderPublicPortal() {
  portalShell('Member portal', `<section class="auth-shell"><aside class="auth-welcome"><p class="eyebrow">Sentinel Baptist Church</p><h2>A thoughtful place to begin.</h2><p>Apply for membership, check your application, and stay connected with church staff.</p><div class="auth-welcome-note"><strong>Your information is private.</strong><span>Membership details are reviewed only by authorised church staff.</span></div></aside><div class="auth-forms"><form id="login-form" class="card auth-card"><p class="eyebrow">Returning member</p><h2>Sign in</h2><p class="text-slate-600">Use your email and password to continue.</p><label class="field-label">Email address<input name="email" type="email" autocomplete="email" placeholder="you@example.com" required></label><label class="field-label">Password<input name="password" type="password" autocomplete="current-password" placeholder="Your password" required></label><button class="auth-submit">Sign in securely</button></form><form id="register-form" class="card registration-card"><p class="eyebrow">New application</p><h2>Apply for membership</h2><p class="text-slate-600">Please complete the form below. You can expect a pastoral review after confirming your email.</p><section class="form-section"><h3>Personal details</h3><div class="form-grid"><input name="full_name" placeholder="Full name" required><input name="date_of_birth" type="date" required><select name="gender" required><option value="">Gender</option><option>Female</option><option>Male</option><option>Prefer not to say</option></select><input name="phone" placeholder="Phone number" required><input name="email" type="email" placeholder="Email address" required><textarea name="address" placeholder="Home address" required></textarea></div></section><section class="form-section"><h3>Family and work</h3><div class="form-grid"><select name="marital_status" required><option value="">Marital status</option><option>Single</option><option>Married</option><option>Widowed</option><option>Divorced</option></select><input name="spouse_name" placeholder="Spouse name (if applicable)"><input name="children_count" type="number" min="0" placeholder="Number of children"><input name="occupation" placeholder="Occupation / work"></div></section><section class="form-section"><h3>Church background</h3><div class="form-grid"><label class="field-label">Have you been baptized by immersion after professing faith?<select name="baptized" required><option value="">Select one</option><option value="true">Yes</option><option value="false">No</option></select></label><input name="baptism_date" type="date" placeholder="Baptism date"><input name="baptism_church" placeholder="Church where baptized"><label class="field-label">Have you previously been a church member?<select name="previous_membership" required><option value="">Select one</option><option value="true">Yes</option><option value="false">No</option></select></label><input name="previous_church" placeholder="Previous church (if applicable)"><textarea name="previous_membership_reason" placeholder="Why did you leave or seek transfer from the previous church?"></textarea></div><label class="check"><input name="transfer_requested" type="checkbox" value="true"> I am requesting a membership transfer</label></section><section class="form-section"><h3>Your testimony</h3><p class="section-help">These questions guide a pastoral conversation; only God knows the heart.</p><textarea name="salvation_story" placeholder="Please share how you came to trust in Jesus Christ." required></textarea><textarea name="gospel_understanding" placeholder="In your own words, what is the gospel?" required></textarea><textarea name="repentance_and_faith" placeholder="What do repentance and faith in Christ mean to you?" required></textarea><textarea name="assurance_of_salvation" placeholder="On what basis do you have assurance of salvation?" required></textarea></section><section class="form-section"><h3>Ministry and emergency contact</h3><fieldset><legend>Ministry interests</legend><label class="check"><input name="ministry_interests" type="checkbox" value="Children"> Children</label><label class="check"><input name="ministry_interests" type="checkbox" value="Youth"> Youth</label><label class="check"><input name="ministry_interests" type="checkbox" value="Music"> Music</label><label class="check"><input name="ministry_interests" type="checkbox" value="Evangelism"> Evangelism</label><label class="check"><input name="ministry_interests" type="checkbox" value="Hospitality"> Hospitality</label></fieldset><div class="form-grid"><input name="emergency_contact_name" placeholder="Emergency contact name" required><input name="emergency_contact_phone" placeholder="Emergency contact phone" required></div></section><section class="form-section final-section"><h3>Create your sign-in</h3><label class="field-label">Password<input name="password" type="password" minlength="8" autocomplete="new-password" placeholder="At least 8 characters" required></label><label class="check"><input name="consent" type="checkbox" required> I consent to Sentinel Baptist Church securely using this information for membership and pastoral care.</label><button class="auth-submit">Submit membership application</button></section></form></div></section>`);
